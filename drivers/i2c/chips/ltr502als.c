...
//Div2D5-OwenHuang-BSP2030_SF5_Proximity_Threshold-00+{
	else if (fih_get_product_id() == Product_SF5)
	{
		...
		if (fih_get_product_phase() > Product_PR2) //for PCR
		{
			...
			//Dio: Following Optical team's comment, change proximity threshold to 0XC = 15
			Command = (val & 0xC0) | 0x0F;
		}
		else
		{
...
/* Dio 2011/7/11 04:31, fix 13 value in FQC by NK OwenHuang's comment for SFXG project*/
		#if 0
		//Div2D5-OwenHuang-SF5_ALSPS_Fine_Tune-00+{
