...
struct hm0357_i2c_reg_conf const hm0357_init_tbl[] =
{
	...
	{0x0020, 0x0008, BYTE_LEN, 0},// Reset         //20100901	W 30 08->0x68	//�ק��~���G                                                   
	...
	{0x038F, 0x000B, BYTE_LEN, 0},//AE Max exposure
	{0x0390, 0x00A5, BYTE_LEN, 0},//AE Max exposure , 5 fps
	{0x0391, 0x0008, BYTE_LEN, 0},//AE Min exposure for LV16
	{0x0393, 0x0080, BYTE_LEN, 0},//                                                                                                     
	{0x0395, 0x0012, BYTE_LEN, 0},//                                                                                                     
	{0x0398, 0x0002, BYTE_LEN, 0},//Frame rate control                                                                                  
	{0x0399, 0x00EA, BYTE_LEN, 0},//	20 fps                                                                                                    
	{0x039A, 0x0004, BYTE_LEN, 0},//	                                                                                                    
	{0x039B, 0x0014, BYTE_LEN, 0},//	15 fps                                                                                                    
	{0x039C, 0x0005, BYTE_LEN, 0},//                                                                                              
	{0x039D, 0x00D3, BYTE_LEN, 0},//	10 fps                                                                                                    
	{0x039E, 0x0007, BYTE_LEN, 0},//                                                                                              
	{0x039F, 0x00C1, BYTE_LEN, 0},//	7.5 fps                                                                                               
	{0x03A0, 0x000B, BYTE_LEN, 0},//                                                                                             
	{0x03A1, 0x00A5, BYTE_LEN, 0},//	5 fps                                                                                             
	...
	{0x05B0, 0x0038, BYTE_LEN, 0},//Edge strength 28->38 for normal light EE
	{0x05B1, 0x0002, BYTE_LEN, 0},//06->02 for low light noise
