...
struct mt9p111_i2c_reg_conf const init_tbl[] = {
    ...
    {0xA01A, 0x0095, WORD_LEN, 0 }, 	// FD_EXPECTED50HZ_FLICKER_PERIOD_IN_CONTEXT_B	//0x0075	//SW4-L1-HL-Camera-ChangeFocusModeFromFasAfToFullScan-00*
    {0xA01C, 0x00B2 , WORD_LEN, 0 },	// FD_EXPECTED60HZ_FLICKER_PERIOD_IN_CONTEXT_A
    {0xA01E, 0x007C, WORD_LEN, 0 }, 	// FD_EXPECTED60HZ_FLICKER_PERIOD_IN_CONTEXT_B	//0x0062	//SW4-L1-HL-Camera-ChangeFocusModeFromFasAfToFullScan-00*
...
static struct mt9p111_i2c_reg_conf const iq_tbl[] = {
    ...
    { 0x8419, 0x05 , BYTE_LEN, 0 }, // SEQ_STATE_CFG_1_AF	//0x04	//SW4-L1-HL-Camera-ChangeFocusModeFromFasAfToFullScan-00*
...
static struct mt9p111_i2c_reg_conf const char_tbl[] = {
	...
	//SW4-L1-HL-Camera-ChangeFocusModeFromFasAfToFullScan-00*{	
	#if 0
...
static const struct mt9p111_i2c_reg_conf const AF_setting[] = {
	...
	//{ 0xC402, 0x00, BYTE_LEN, 0 },	// AFM_MODE 	//SW4-L1-HL-Camera-ChangeFocusModeFromFasAfToFullScan-00-
	...
	//SW4-L1-HL-Camera-ChangeFocusModeFromFasAfToFullScan-00*{
	{ 0xB002, 0x0305, WORD_LEN, 0 },  // AF_MODE	//0x0002
	//2nd_scan_option
